...
/**
 * Created by PheonixSoft on 19-May-18.
 */
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, Objects.requireNonNull(getContext()).getString(R.string.libName));
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_android_black_24dp);
